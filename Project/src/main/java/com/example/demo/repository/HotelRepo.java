...
{
	@Query(value="Select * from hotels where hotel_name=:str or city=:s", nativeQuery = true)
	public List<HotelEntity> getbyQ(@Param("str") String name, @Param("s") String city);
