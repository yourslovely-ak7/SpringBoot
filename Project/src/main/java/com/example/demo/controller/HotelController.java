...
public class HotelController 
{
	...
	@PostMapping("hotpostdata")
	public HotelEntity saveInfo(@RequestBody HotelEntity hca)
	{
		return hs.save(hca);
	}
	...
	@GetMapping("hotgetbyQ/{name}/{city}")
	public List<HotelEntity> getbyQ(@PathVariable String name, @PathVariable String city)
	{
		return hs.getbyQ(name,city);
	}
