...
public class UserController {
	...
	public UserEntity create(@RequestBody UserEntity uc)
	{
		return us.saveInfo(uc);
	}
	...
	public UserEntity getbyMail(@PathVariable String mail)
	{
		return us.getbymail(mail);
	}
}
